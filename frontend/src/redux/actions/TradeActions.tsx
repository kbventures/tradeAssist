...
import * as actions from '../constants/TradeConstants';
import { TCreateTrade } from '../../interfaces/ITrade';
...
export const createTrade = (tradeData: TCreateTrade) => async (dispatch: Dispatch, getState: any) => {
